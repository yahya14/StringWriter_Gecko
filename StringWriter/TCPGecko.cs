...
namespace StringWriter
{
    ...
    public class TCPGecko
    {
        ...
        public void Dump(UInt32 startdump, UInt32 enddump, Stream[] saveStream)
        {
            ...
            if (global::StringWriter.ValidMemory.rangeCheckId(startdump) != global::StringWriter.ValidMemory.rangeCheckId(enddump))
            {
                enddump = global::StringWriter.ValidMemory.ValidAreas[global::StringWriter.ValidMemory.rangeCheckId(startdump)].high;
            }

            if (!global::StringWriter.ValidMemory.validAddress(startdump)) return;
        ...
        */
        ...
        {
            if (!global::StringWriter.ValidMemory.validAddress(address))
            {
                return 0;
            }
